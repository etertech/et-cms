...
public class Bank {
	...
	public void run() {
		...
		System.out.println("Amount (decimam) to deposit into your checking account?");
		double amount = scanner.nextDouble(); //get next token (double)
		checkingAccount.deposit(amount); //deposit into checking account
		
		//into checking
		System.out.println();//blank line
		System.out.println("Amount (decimam) to deposit into your savings account?");
		...
		//from checking
		System.out.println();//blank line
		System.out.println("Amount (decimam) to withdraw from your checking account?");
		amount = scanner.nextDouble(); //get next token (double)
		try {
		...
		//from savings
		System.out.println();//blank line
		System.out.println("Amount (decimam) to withdraw from your savings account?");
		amount = scanner.nextDouble(); //get next token (double)
		try {
